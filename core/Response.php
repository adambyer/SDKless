...
class Response {
	...
	public function get($config) {
		...
		$this->http_code_check($this->last_http_code);
	...
	public function do_curl() {
	  ...
	  error_log("*** SDKless::do_curl:http_code:{$this->last_http_code}");
	...
	private function get_curl_opts() {
		$curl_options = $this->config->get_endpoint_setting('curl_options');
		$opts = array();
